...
public class triangle extends RelativeLayout {
    ...
    public static int LEG_HALF_BASE = 80;
    ...
    public triangle(Context context, AttributeSet attrs,int color) {
        this(context, attrs,0,color);
    }

    public triangle(Context context, AttributeSet attrs, int defStyle,int color) {
        super(context,attrs,defStyle);
        init(context,attrs,color);

    }

    private void init(final Context context, final AttributeSet attrs,int color) {
